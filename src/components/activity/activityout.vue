    ...
    <div class="container">
      ...
      <form class="activity-form" @submit.prevent="submitForm">
        ...
        <div class="form-section">
          ...
          <div class="form-row">
            <div class="form-group half-width">
              <label for="activity-time" class="required">活动时间</label>
              <input 
                type="datetime-local" 
                id="activity-time" 
          ...
          <div class="form-group">
            ...
            <div class="benefits-description">
              <textarea 
                ...
                maxlength="200"
              ></textarea>
              <div class="char-count">{{ formData.benefits_details.length }}/200</div>
            </div>
          </div>
        </div>
        ...
        <div class="form-section">
            ...
            <div class="options-container">
              ...
              >
                <input 
                  ...
                  @change="handleAudienceChange(audience.value)"
                >
          ...
          <div class="form-group">
            <label for="activity-majors">专业要求</label>
            <input 
              type="text" 
              id="activity-majors" 
              v-model="formData.major_requirements" 
              placeholder="不限专业"
            >
          </div>
        </div>
...
const handleAudienceChange = (value) => {
  if (value === 'all') {
    ...
    // 如果选择了具体年级，移除"不限年级"选项
    const allIndex = formData.target_audience.indexOf('all')
    if (allIndex > -1) {
      formData.target_audience.splice(allIndex, 1)
    }
  }
}
...
const setDefaultTime = () => {
  ...
  formData.activity_time = `${year}-${month}-${day}T${hours}:${minutes}`
}
...
const prepareFormData = () => {
  ...
  submitData.append('activity_time', formData.activity_time)
  submitData.append('description', formData.description)
  submitData.append('benefits_details', formData.benefits_details)
  submitData.append('major_requirements', formData.major_requirements)
...
const submitForm = async () => {
  ...
  try {
    ...
    const response = await activityAPI.createActivity(formDataToSubmit)
